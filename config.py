...
games = collections.OrderedDict([
    ("dcss-web-trunk", dict(
        ...
        # env = {"LANG": "en_US.UTF8"},
         ...
         ("dcss-circus-animals", dict(
        name = "Play DCSS-Circus-Animals",
        crawl_binary = "../../dcssca/crawl",
        rcfile_path = "../../../dcssca/data/ca-rcs/",
        macro_path = "../../../dcssca/data/ca-rcs/",
        morgue_path = "../../../dcssca/data/ca-rcs/%n",
        inprogress_path = "../../../dcssca/data/ca-rcs/running",
        ttyrec_path = "../../../dcssca/data/ca-rcs/ttyrecs/%n",
        socket_path = "../../../dcssca/data/ca-rcs",
        client_path = "./webserver/game_data/",
        # dir_path = ".",
        # cwd = ".",
        morgue_url = None,
